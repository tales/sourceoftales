 <tileset firstgid="1" name="terrains" tilewidth="32" tileheight="32">
  <image source="./water.png" width="96" height="192"/>
  <terraintypes>
   <terrain name="Water" tile="10" distances=",0,1,1,1"/>
  </terraintypes>
  <xtile id="1" terrain="tl,tr,bl,br"/>
